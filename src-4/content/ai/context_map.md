...
![Godot 4: Context-based steering (ai context 01)](/godot_recipes/3.x/img/ai_context_01.png)

In our agent's script, we'll store an array called `interest`, tracking in which directions the agent wants to go.

![Godot 4: Context-based steering (ai context 04)](/godot_recipes/3.x/img/ai_context_04.png)
...
![Godot 4: Context-based steering (ai context 03)](/godot_recipes/3.x/img/ai_context_03.png)

In this case, the `interest` array would look like this:

![Godot 4: Context-based steering (ai context 05)](/godot_recipes/3.x/img/ai_context_05.png)
...
![Godot 4: Context-based steering (ai context 06)](/godot_recipes/3.x/img/ai_context_06.png)

Now we'll introduce a second array, `danger`, that indicates directions that are not preferred.

![Godot 4: Context-based steering (ai context 07)](/godot_recipes/3.x/img/ai_context_07.png)
...
![Godot 4: Context-based steering (ai context 08)](/godot_recipes/3.x/img/ai_context_08.png)
...
![Godot 4: Context-based steering (ai context 09)](/godot_recipes/3.x/img/ai_context_09.png)
...
![Godot 4: Context-based steering (ai context 11)](/godot_recipes/3.x/img/ai_context_11.png)
...
![Godot 4: Context-based steering (ai context 10)](/godot_recipes/3.x/img/ai_context_10.gif)
