...
広告は必ずしも好まれるものではなく、その導入の有無は個々のゲーム開発者が判断しましょう。本チュートリアルではメリット・デメリットの検討には踏み込みません。ここでは「もし広告を実装したい」と考えている方向けに、その方法を丁寧に解説します。
...
![Godot 4: モバイル広告 (cj 11 01)](/godot_recipes/4.x/img/cj_11_01.png)
...
![Godot 4: モバイル広告 (cj 11 02)](/godot_recipes/4.x/img/cj_11_02.png)
...
![Godot 4: モバイル広告 (cj 11 03)](/godot_recipes/4.x/img/cj_11_03.jpg)
...
![Godot 4: モバイル広告 (cj 11 04)](/godot_recipes/4.x/img/cj_11_04.png)
