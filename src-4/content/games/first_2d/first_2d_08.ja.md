...
| {{% button href="/godot_recipes/4.x/games/first_2d/first_2d_07/" icon="fas fa-arrow-left" %}} 前のステップ{{% /button %}} | {{% button href="/godot_secretaries/4.x/games/first_2d/first_2d_09/" icon="fas fa-arrow-right" icon-position="right" %}} 次のステップ{{% /button %}} |
|------|------:|
