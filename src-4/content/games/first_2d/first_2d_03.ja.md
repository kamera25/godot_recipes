...
**ノードスクリプトのアタッチ** ウィンドウでオプションを変更する必要はありませんので、単に **作成** ボタンをクリックすると、スクリプトエディタに移動します。
