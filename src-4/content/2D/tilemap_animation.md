...
![Godot 4: TileMap: animated tiles (anim tiles)](/godot_recipes/3.x/img/anim_tiles.png)
...
![Godot 4: TileMap: animated tiles (create new resource)](/godot_recipes/3.x/img/create_new_resource.png)
...
![Godot 4: TileMap: animated tiles (anim texture add)](/godot_recipes/3.x/img/anim_texture_add.png)
...
![Godot 4: TileMap: animated tiles (anim tile add)](/godot_recipes/3.x/img/anim_tile_add.png)
...
![Godot 4: TileMap: animated tiles (anim tile select)](/godot_recipes/3.x/img/anim_tile_select.png)

Now you can select the tile in your `TileMap` and draw with it just like any other tile.

![Godot 4: TileMap: animated tiles (anim tile draw)](/godot_recipes/3.x/img/anim_tile_draw.gif)
