...
description: "Godot 4のCharacterBody2Dで、ジャンプ・重力・加速・摩擦を備えた2Dプラットフォームキャラクターを実装する方法。"
weight: 1
draft: false
ghcommentid: 16
---
...
この動作を実現する効果的な方法の一つが線形補間(lerp）を使用することです。移動中は現在速度と最大速度の間で補間し、停止時は現在速度から`0`まで補間します。補間量を調整することで、さまざまな移動スタイルを実現できます。
