...
どうすれば船を前方に移動させることができるでしょうか？学校で三角関数を学んでいた方なら、角度や三角関数の概念を思い出し、`position += Vector2(10 * cos(angle), 10 * sin(angle))`のような計算式を考えつくかもしれません。この方法でも実現可能ですが、より便利な方法があります。それは **Transform** です。
