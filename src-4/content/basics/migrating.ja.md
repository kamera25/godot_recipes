...
これは、4.0への移行時に注意した方が良い主要な変更点と「落とし穴」をまとめた随時更新リストです。

## 新しい名称

Godot 4での最も大きな変化の一つは、ノード名、関数名、プロパティ名などの大量のリネームです。これらの多くは仕様の一貫性や可読性を向上させるために行われています。特に注意したほうが良い主要な変更点をご紹介します。
