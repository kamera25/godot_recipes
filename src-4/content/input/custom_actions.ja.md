...
通常、入力アクションは[プロジェクト設定]から追加します（詳細は[レシピ：入力アクション]参照）。ただし、スクリプト内で直接アクションを追加する必要がある場合もあります。このような場合には、［InputMapシングルトン］(https://docs.godotengine.org/ja/latest/classes/class_inputmap.html)が提供するメソッドが便利です。
