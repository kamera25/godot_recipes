...
> **Note:** Be careful to never scale your collision shapes in the editor. The `Scale` property in the Inspector should remain at `(1, 1)`. When changing the size of the collision shape, you should always use the shape's handles.
...
![Godot 4: Using CharacterBody2D (k2d layer names)](/godot_recipes/3.x/img/k2d_layer_names.png?width=300)

A body's layer properties can be configured via code, or directly in the Inspector:

![Godot 4: Using CharacterBody2D (k2d layer example)](/godot_recipes/3.x/img/k2d_layer_example.png?width=300)
...
![Godot 4: Using CharacterBody2D (k2d compare)](/godot_recipes/3.x/img/k2d_compare.gif)
...
![Godot 4: Using CharacterBody2D (k2d bullet bounce)](/godot_recipes/3.x/img/k2d_bullet_bounce.gif)
...
![Godot 4: Using CharacterBody2D (k2d platf sample)](/godot_recipes/3.x/img/k2d_platf_sample.gif?width=300)
