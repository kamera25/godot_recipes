...
以下の 2 つの {{< gd-icon Sprite2D >}}`Sprite2D`ノードを追加してください: "MobMarker" と "AlertMarker"。テクスチャには `minimapIcon_jewelRed.png` および `minimapIcon_exclamationYellow.png` を使いましょう。
