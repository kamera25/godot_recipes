...
[Godot公式ウェブサイトのGDScriptドキュメント](https://docs.godotengine.org/ja/stable/tutorials/scripting/gdscript/gdscript_basics.html)は、言語の基本を理解するための最適なリソースです。時間を取ってしっかり読み込むことを強くお勧めします。
...
プログラミングを始めたばかりの人が「これらすべてのコマンドをどうやって覚えればいいですか？」とよく質問します。他のどんなスキルとも同様に、これは暗記ではなく練習次第なのです。使えば使うほど、頻繁に使う機能は自然と身につき、無意識に扱えるようになります。それまでは、リファレンスドキュメントをすぐに参照できるようにしておくことをおすすめします。わからないものに出会ったら、いつでも検索機能を使いましょう。複数モニターを使用している場合は、[Webドキュメント](https://docs.godotengine.org/ja/latest/)を横に開いておき、素早く確認できる状態にしておくと便利です。
{{% /notice %}}
