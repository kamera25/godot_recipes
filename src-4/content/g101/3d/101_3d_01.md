...
![Godot 4: The 3D Editor (3d workspace)](/godot_recipes/4.x/img/3d_workspace.png)
...
![Godot 4: The 3D Editor (3d intro perspective)](/godot_recipes/4.x/img/3d_intro_perspective.png)
...
![Godot 4: The 3D Editor (3d gizmo)](/godot_recipes/4.x/img/3d_gizmo.png)
...
![Godot 4: The 3D Editor (3d intro mode buttons)](/godot_recipes/4.x/img/3d_intro_mode_buttons.png)
{{% /notice %}}
...
![Godot 4: The 3D Editor (3d local space button)](/godot_recipes/4.x/img/3d_local_space_button.png)
...
![Godot 4: The 3D Editor (3d intro cube labels)](/godot_recipes/4.x/img/3d_intro_cube_labels.png)
...
![Godot 4: The 3D Editor (3d primitives)](/godot_recipes/4.x/img/3d_primitives.png)
...
![Godot 4: The 3D Editor (3d camera position)](/godot_recipes/4.x/img/3d_camera_position.png)
