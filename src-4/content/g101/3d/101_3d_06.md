...
Create a new scene with a `Node3D` root, then add a child node and type "CSG"
in the search box.

![Godot 4: Using CSG (3d 06 01)](/godot_recipes/3.x/img/3d_06_01.png?width=400)

These are the available CSG shapes. Choose a `CSGBox` to start. You'll see a
plain cube mesh with the following properties:

![Godot 4: Using CSG (3d 06 02)](/godot_recipes/3.x/img/3d_06_02.png?width=200)
...
![Godot 4: Using CSG (3d 06 03)](/godot_recipes/3.x/img/3d_06_03.png?width=200)
...
![Godot 4: Using CSG (3d 06 04)](/godot_recipes/3.x/img/3d_06_04.gif?width=200)

And "Subtraction":

![Godot 4: Using CSG (3d 06 05)](/godot_recipes/3.x/img/3d_06_05.gif?width=200)

Hopefully you're already seeing the possibilities of creating complex shapes
through these 3 operations.

![Godot 4: Using CSG (3d 06 06)](/godot_recipes/3.x/img/3d_06_06.png?width=300)
...
features that our character can interact with, and that we can use in the upcoming tutorials. Make a new scene with a `Node3D` root that we can start working with.
...
![Godot 4: Using CSG (3d 06 07)](/godot_recipes/3.x/img/3d_06_07.png?width=300)
...
![Godot 4: Using CSG (3d 06 12)](/godot_recipes/3.x/img/3d_06_12.png?width=500)

In this picture, we've created a ramp and added a couple of `CSGBox` shapes to
make the ledge.

![Godot 4: Using CSG (3d 06 08)](/godot_recipes/3.x/img/3d_06_08.png?width=300)
...
![Godot 4: Using CSG (3d 06 13)](/godot_recipes/3.x/img/3d_06_13.png?width=300)

Hit play and you should be able to walk around the rooms:

![Godot 4: Using CSG (3d 06 10)](/godot_recipes/3.x/img/3d_06_10.gif?width=250)
...
![Godot 4: Using CSG (3d 06 11)](/godot_recipes/3.x/img/3d_06_11.gif?width=250)
