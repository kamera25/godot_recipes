...
Here's the initial script. Note that we're making sure to rotate each {{< gd-icon Node3D >}}`Node3D` in its local space around the specific axis, as described above.
