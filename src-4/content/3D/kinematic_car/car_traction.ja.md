...
あなたは［キネマティックカー］(/godot_recipes/3.x/3d/kinematic_car/car_base/)を持っているものの、特に高速走行時に「レール上を走っている」ような感覚が気に入らないようです。ドリフトやトラクション損失を可能にするため、ある程度の「スリップ」特性が欲しいとお考えですね。
