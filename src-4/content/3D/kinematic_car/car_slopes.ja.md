...
![Godot 4: 3Dで自動車を作ろう：傾斜面＆スロープ (3d car 10)](/godot_recipes/4.x/img/3d_car_10.png)
...
[CharacterBody3D: 表面に合わせる]レシピのコードを再利用します。これを`car_base.gd`に追加しましょう：
...
![Godot 4: 3Dで自動車を作ろう：傾斜面＆スロープ (3d car 12)](/godot_recipes/4.x/img/3d_car_12.png)
